...
parser.add_argument('--sample_step', type=int, default=20, help='step of saving sample images')
...
parser.add_argument('--dim_z_content', type=int, default=50)
parser.add_argument('--dim_z_category', type=int, default=6)
