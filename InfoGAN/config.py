...
parser.add_argument('--image_size', type=int, default=62, help='the height / width of the input image to network')
...
parser.add_argument('--netShareDQ', default='', help="path to netShareDQ (to continue training)")
