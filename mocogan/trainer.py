...
class Trainer(object):
    ...
    def train(self):
        ...
        def sample_fake_video_batch(batch_size):
            return self.generator.sample_videos(batch_size)
        ...
        while True:
            ...
            l_image_dis = self.train_discriminator(self.image_discriminator, self.sample_real_image_batch,
                                                   sample_fake_image_batch, opt_image_discriminator,
                                                   self.image_batch_size, use_categories=False)

            # train video discriminator
            l_video_dis = self.train_discriminator(self.video_discriminator, self.sample_real_video_batch,
