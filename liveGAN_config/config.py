...
parser.add_argument('--enc_size', type=int, default=4, help='encoding size, choose:  4  8  16')
...
parser.add_argument('--L1_lambda', type=int, default=100, help='L1 loss lambda')
